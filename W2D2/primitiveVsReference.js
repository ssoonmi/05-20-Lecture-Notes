...
// Reference Data Types are mutable
  // What these variables point to in memory can be changed
...
// Setting variables equal to each other and memory.
  ...
  // If we set variables holding primitive data types equal to eachother
  // and then change one of those variables, the other variable will remain unchanged.

  // If we set variables holding reference data types equal to eachother
