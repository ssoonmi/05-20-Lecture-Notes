...
def index():
    ...
    # lazy loading
    # get the pet + 1
    # get the owner information for each of the pet's owners +n where n is the number of owners

    # eager loading
    # get the pet + the pet's owners information + 1

    foods = MenuItem.query.options(joinedload(MenuItem.type))
    foods_by_type = {}
    for food in foods:
